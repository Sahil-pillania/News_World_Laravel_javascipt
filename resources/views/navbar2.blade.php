...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="#"><i class="fab fa-neos"></i></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    ...
                    <button class="btn btn-sm btn-success mx-3" type="submit">Search</button>
                    <button class="btn btn-sm btn-warning" type="submit"><a type=button class="nav-link active" href={{url('/logout')}}>Logout</a></button>
                </form>
            </div>
        </div>
    </nav>
